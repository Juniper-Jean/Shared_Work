...
for eachVar in bioclimVars:
    ...
    # Assign a bash command to 'cmd'.
    # 'os.system()' executes the command in the bash shell.
    # 'cmd.format()' returns a formatted version of 'cmd', using substitutions identified by '{}'.
